    ...
    <div class="content mar_20">
    	...
    	<div class="warning">        	
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                	<a href="../Index.jsp">首页</a> &nbsp; &nbsp; <a href="../Index.jsp">用户中心</a>
                </td>
              </tr>
            </table>        	
        </div>
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                    ...
                    <a href="../Index.jsp" style="color:#ff4e00;">立即在线申请</a>
                </td>
              </tr>
              <tr>
                <td>
                	<div class="btn_u" style="margin:0 auto; padding:0 20px; width:120px;"><a href="../Index.jsp">立即使用支付宝支付</a></div>
                	<a href="../Index.jsp">首页</a> &nbsp; &nbsp; <a href="../Index.jsp">用户中心</a>
                </td>
              </tr>
            </table>        	
            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                	...
                	<div class="backs"><a href="../Index.jsp">返回上一页</a></div>
                </td>
              </tr>
            </table>        	
        </div>
