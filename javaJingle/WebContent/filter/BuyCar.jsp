...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
        	...
        	<a href="Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="Index.jsp">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
...
<div class="menu_bg">
	<div class="menu">
                    ...
                    <li>
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                    <h2>零食 / 糖果 / 巧克力</h2>
                                    <a href="Index.jsp">坚果</a>|<a href="Index.jsp">蜜饯</a>|<a href="Index.jsp">红枣</a>|<a href="Index.jsp">牛肉干</a>|<a href="Index.jsp">巧克力</a>|
                                    <a href="Index.jsp">口香糖</a>|<a href="Index.jsp">海苔</a>|<a href="Index.jsp">鱼干</a>|<a href="Index.jsp">蜜饯</a>|<a href="Index.jsp">红枣</a>|
                                    <a href="Index.jsp">蜜饯</a>|<a href="Index.jsp">红枣</a>|<a href="Index.jsp">牛肉干</a>|<a href="Index.jsp">蜜饯</a>|
                                </div>
                                <div class="zj_l_c">
                                    <h2>零食 / 糖果 / 巧克力</h2>
                                    <a href="Index.jsp">坚果</a>|<a href="Index.jsp">蜜饯</a>|<a href="Index.jsp">红枣</a>|<a href="Index.jsp">牛肉干</a>|<a href="Index.jsp">巧克力</a>|
                            ...
                            <div class="zj_r">
                                <a href="Index.jsp"><img src="images/n_img1.jpg" width="236" height="200" /></a>
                                <a href="Index.jsp"><img src="images/n_img2.jpg" width="236" height="200" /></a>
                            </div>
                        </div>
                    </li>
                    <li>
    	...
    	<ul class="menu_r">                                                                                                                                               
            ...
            <li><a href="GoodsServlet">美妆</a></li>
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<table id="buyTable" border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          <tr>
          	<td class="car_th" width="60">可选项</td>
            <td class="car_th" width="490">商品名称</td>
            <td class="car_th" width="180">属性/颜色</td>
            <td class="car_th" width="160">购买数量</td>
            <td class="car_th" width="140">小计</td>
            <td class="car_th" width="60">操作</td>
          </tr>
          <c:forEach var="i" items="${buyCartDetails}">
          <tr class="car_tr">
          	<td class="car_th" width="60"><input type="checkbox" name="ckb"/></td>
            <td class="car_th" width="490">
            	<div class="c_s_img"><img src="${i.imageUrl}" width="73" height="73" /></div>
                ${i.goodsName}
            </td>
            <td align="center" class="car_th" width="140">属性：${i.goodsType} 颜色：${i.goodsColor}</td>
            <td align="center" class="car_th" width="150">
            	<div class="c_num">
            		<input type="hidden" value="${i.goodsId }" class="goodsid"/> 
                    <input type="button" value="" onclick="jianUpdate1(jq(this));" class="car_btn_1" />
                	<input type="text" value="${i.goodsNumber}" name="" class="car_ipt" />               
                    <input type="button" value="" onclick="addUpdate1(jq(this));" class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;" class="car_th" width="130"><span id="buySubTotal">￥${i.subtotal}</span></td>
            
            <td align="center" class="car_th" width="60"><a href="javascript:void(0)" onclick="ShowDiv_1('MyDiv','fade')">删除</a></td>
          </tr>
          </c:forEach>    
          <tr height="70">
          	<td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
            	<label class="r_rad"><input type="checkbox" name="clear" checked="checked" onclick="checkAll();"/></label><label class="r_txt">清空购物车</label>
                <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥${CartSubToTal}</b></span>
            </td>
          </tr>
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="GoodsServlet"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; <a href="BuyCar_Two.jsp"><img src="images/buy2.gif" /></a>
            </td>
          </tr>
          </table>
    ...
    <div id="MyDiv" class="white_content">             
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv_1('MyDiv','fade')"><img src="images/close.gif" /></span>
            </div>
            <div class="notice_c">
           		
                <table border="0" align="center" style="font-size:16px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td>您确定要把该商品移出购物车吗？</td>
                  </tr>
                  <tr height="50" valign="bottom">
                    <td><a href="Index.jsp" class="b_sure">确定</a><a href="Index.jsp" class="b_buy">取消</a></td>
                  </tr>
                </table>
    ...
    <div class="b_nav">
        ...
        <dl>
            ...
            <dd><a href="Member_Collect.jsp">我的收藏</a></dd>
...
<script type="text/javascript">
	function checkAll(){
		var ckd = $("input[name='clear']").attr("checked");
		console.log("全选框的属性值："+ckd);
		var c = $("input[name='ckb']");
		console.log(c);
		for(var i in c){	
			i.attr("checked",ckd);
		}
