...
<div class="i_bg bg_color">
	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="MyInfoServlet" class="now">用户信息</a></li>
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="Member_User.jsp">我的会员</a></li>
		...
		<div class="m_right">
            	...
            	<table border="0" style="width:870px; line-height:22px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    ...
                    <td>
                        ...
                        <p>
                            等级：注册用户 <br/>                  
                            您还没有通过邮件认证 <a href="../Index.jsp" style="color:#ff4e00;">点此发送认证邮件</a>
                        </p>
                        <div class="m_notice">
                        	用户中心公告！
                        </div>
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="40%">用户ID：<span style="color:#555555;">${user.userId }</span></td>
                <td width="60%">性别：<span style="color:#555555;">${user.userSex }</span></td>
              </tr>
              <tr>
                <td>电&nbsp; &nbsp; 话：<span style="color:#555555;">${user.userPhone }</span></td>
                <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;">${user.userEmail }</span></td>
              </tr>
              <tr>
                <td>身份证号：<span style="color:#555555;">${user.userCard }</span></td>
              </tr>
            </table>
    ...
    <div class="b_nav">
        ...
        <dl>
        	<dt><a href="../Index.jsp">会员中心</a></dt>
            <dd><a href="../Index.jsp">资金管理</a></dd>
            <dd><a href="../Index.jsp">我的收藏</a></dd>
            <dd><a href="../Index.jsp">我的订单</a></dd>
        </dl>
        <dl>
